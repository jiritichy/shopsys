...
use Shopsys\ReadModelBundle\Product\Detail\DetailProductViewFacade;
...
class ProductController extends FrontBaseController
{
    ...
    /**
     * @var \Shopsys\ReadModelBundle\Product\Listed\ListedProductVariantsViewFacade
     */
    protected $listedProductVariantsViewFacade;

    /**
     * @var \Shopsys\ReadModelBundle\Product\Detail\DetailProductViewFacade
     */
    protected $detailProductViewFacade;
     ...
     * @param \Shopsys\ReadModelBundle\Product\Listed\ListedProductVariantsViewFacade $listedProductVariantsViewFacade
     * @param \Shopsys\ReadModelBundle\Product\Detail\DetailProductViewFacade $detailProductViewFacade
     */
    public function __construct(
        ...
        ListedProductVariantsViewFacade $listedProductVariantsViewFacade,
        DetailProductViewFacade $detailProductViewFacade
    ) {
        ...
        $this->detailProductViewFacade = $detailProductViewFacade;
    }
    ...
    {
        $detailProductView = $this->detailProductViewFacade->getVisibleProductDetail($id);

        if ($detailProductView->getMainVariantId() !== null) {
            return $this->redirectToRoute('front_product_detail', ['id' => $detailProductView->getMainVariantId()]);
        }
